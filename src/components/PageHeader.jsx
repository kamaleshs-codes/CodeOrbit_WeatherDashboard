        ...
        {weatherAlerts.length > 0 && (
          <div className='relative'>
            <button
              ...
              className='flex items-center gap-2 text-sm font-semibold text-text-muted hover:text-accent transition-colors'>
              <LuTriangleAlert className='w-5 h-5 text-yellow-700' />
              <span>
                Weather Alert
                {weatherAlerts.length > 1 && ` (${weatherAlerts.length})`}
              </span>
              <LuChevronDown
