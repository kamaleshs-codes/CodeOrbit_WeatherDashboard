    ...
    <main className='min-h-screen bg-main text-text-main'>
          ...
          <div className='rounded-3xl border border-border-muted bg-gradient-to-br from-hero-start via-hero-mid to-hero-end p-8 shadow-subtle sm:p-12 lg:p-16'>
            <div className='max-w-3xl'>
              <div className='mb-6 inline-flex items-center gap-2 rounded-xl border border-border-muted bg-secondary px-5 py-3 font-semibold text-text-main shadow-subtle'>
                ...
                <span className='text-accent'>About Weatherly</span>
              </div>

              <h1 className='text-4xl font-bold leading-tight text-accent-secondary sm:text-5xl lg:text-6xl'>
                Understanding the project
                <span className='text-accent'> behind the dashboard.</span>
              </h1>
              ...
              <p className='mt-6 max-w-2xl text-base leading-7 text-secondary dark:text-text-muted sm:text-lg'>
                ...
                real-world frontend development, API integration, responsive
                UI design, and data-driven application development.
              </p>

              <div className='mt-8'>
                <Link
                  to='/dashboard'
                  className='inline-flex items-center gap-2 rounded-lg bg-secondary px-5 py-3 font-semibold text-text-main shadow-subtle transition hover:scale-[1.02] hover:bg-accent hover:text-secondary'
                >
        ...
        <div className='mx-auto grid max-w-7xl gap-8 lg:grid-cols-2'>
          <div>
            ...
            <p className='mt-4 leading-7 text-text-light-secondary'>
              <strong>The project is designed around a simple idea:</strong> Weather data can
              become much more useful when it is presented through a clean,
              understandable, and responsive experience.
            </p>
          </div>
          ...
          <div className='rounded-2xl border border-border-muted bg-accent-secondary p-7 shadow-subtle'>
            ...
            <p className='mt-3 leading-7 text-accent font-semibold'>
              Every part of the application provides an opportunity to
              practice a real development concept — from component
              architecture and API communication to backend services and
        ...
        <div className='mx-auto max-w-7xl'>
          <div className='max-w-2xl'>
            ...
            <p className='mt-4 leading-7 text-text-light-secondary'>
              ...
              application to turn external weather data into a usable
              dashboard.
            </p>
          </div>
          ...
          <div className='mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4'>
            {[
              ...
              >
                <span className='text-sm font-bold text-text-muted p-2 rounded-full bg-accent'>
                  {step.number}
                </span>
              ...
              return (
                ...
                >
                  <div className='flex h-11 w-11 items-center justify-center rounded-lg bg-secondary'>
                    <Icon size={23} className='text-main' />
                  </div>
                  ...
                  <p className='mt-2 text-sm leading-6 text-accent font-semibold'>
          ...
          <div className='rounded-2xl border border-border-muted bg-primary p-8 shadow-subtle sm:p-10'>
            <div className='flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between'>
              <div className='max-w-2xl'>
                ...
                <p className='mt-4 leading-7 text-text-light-secondary'>
                  The current version focuses on the core dashboard
                  experience. Future development can introduce stronger
                  backend architecture, user accounts, weather history,
                  analytics, and AI-assisted weather insights.
                </p>
              </div>
      ...
      <section className='px-6 py-16 sm:px-10 lg:px-16'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <Link
            to='/dashboard'
            className='mt-7 inline-flex items-center gap-2 rounded-lg bg-accent px-6 py-3 font-semibold text-secondary shadow-subtle transition hover:scale-[1.02]'
          >
            Open Dashboard
            <ArrowRight size={18} />
          </Link>
